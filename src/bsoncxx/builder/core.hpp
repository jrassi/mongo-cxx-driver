...
class BSONCXX_API core {
   public:
    ...
    ///
    /// @pre
    ///    The top-level BSON datum should be a document that is not waiting for a key to be pushed,
    ///    and does contain any open sub-documents or open sub-arrays.
    ///
    ...
    /// @pre
    ///    The top-level BSON datum should be a document that is not waiting for a key to be pushed,
    ///    and does not contain any open sub-documents or open sub-arrays.
    ///
    /// @throws bsoncxx::exception if the precondition is violated.
    ///
    /// @warning
